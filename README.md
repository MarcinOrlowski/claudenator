...
after the session id. `conclaude` finds every session, shows what it is and how much disk it takes, and, in
the releases that follow, moves the ones you pick to a Trash you can restore from.

## Install

```bash
pipx install https://github.com/MarcinOrlowski/conclaude.git
```
